...
from telethon.tl.types import InputMessagesFilterPhotos, InputMessagesFilterEmpty, MessageService
...
class InteractiveTelegramClient(TelegramClient):
    ...
    async def run(self):
        ...
        while True:
            ...
            print('  !h:  prints the latest messages (message History) and DELETE service messages.')
            ...
            while True:
                ...
                # History
                    ...
                    messages = await self.get_messages(entity, limit=300)
                    ...
                    for msg in reversed(messages):
                        ...
                        if isinstance(msg, MessageService):
                            print("Service message. ", msg)
                            # Delete the service message
                            result = await client.delete_messages(entity, [msg.id])
                            print("Service message deleted: ", result)
...
client = InteractiveTelegramClient(
    os.environ.get('TG_SESSION', 'session'),
    os.environ['TG_PHONE_NUMBER'],
